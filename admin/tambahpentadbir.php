<?php
	...
	{	
		...
		$myKpStaf = addslashes( $_POST['no_kp'] ); //prevents types of SQL injection
		
		$queryExist=mysqli_query($conn, "SELECT id FROM jpentadbir jpe WHERE jpe.no_staf='$myNoStaf'");
		$kpExist=mysqli_query($conn, "SELECT id FROM jpentadbir jpe WHERE jpe.no_kp='$myKpStaf'");
		...
		elseif(mysqli_num_rows($kpExist) == 1){
			$_SESSION['addnew_errors'] = array("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ralat. No K/P sudah berdaftar.");
		}
		else{
