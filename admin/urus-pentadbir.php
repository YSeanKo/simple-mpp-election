                                    ...
                                    <form class="form-horizontal form-label-left input_mask" method="POST" action="editpentadbir.php">
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-9 col-xs-12">
												<input name="id" type="hidden" class="form-control" value="<?php echo $_SESSION['id_pentadbir']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-9 col-xs-12">
                                                <input type="text" class="form-control" value="<?php echo $_SESSION['nama_penuh']?>" readonly="readonly">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label class="control-label col-md-4 col-sm-3 col-xs-12">No. K/P</label>
                                            <div class="col-md-6 col-sm-9 col-xs-12">
                                                <input type="text" class="form-control" value="<?php echo $_SESSION['no_kp']?>" readonly="readonly" placeholder="931210085704">
                                            </div>
                                        </div>
										<div class="form-group">
