...
<head>
 ...
 <div id="header" class="text-center" style="font-family: 'Raleway', Arial, sans-serif;">
    ...
    font-weight: 800;
    text-transform: uppercase;">Pencalonan Majlis Perwakilan Pelajar</h1>
        <h3 style="font-size: 28px;
    font-weight: 600;">ILP Ledang Bestari Dalam Taman</h3>
    </div>
  ...
  <center><h3>Anda tidak mempunyai akses ke laman ini. <br>Sila <a href="index.php">log masuk</a> terlebih dahulu.</p>
</div></div>
    </div> <!-- /container -->
